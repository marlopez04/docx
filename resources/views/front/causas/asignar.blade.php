                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">ASIGNAR (VOCALIA ) </h4>
                                    <h5 class="card-title">Fuero: (PENDIENTE)</h5>
                                    <h5 class="card-title">N° expendiente: {{ $sentencia->causa->numero_expediente }}</h5>
                                    <h5 class="card-title">Actor: {{ $sentencia->causa->actor_imputado }}</h5>
                                    <h5 class="card-title">Demandado: {{ $sentencia->causa->demandado_victima }}</h5>
                                    <h5 class="card-title">Tipo de Sentencia: {{ $sentencia->tipo }}</h5> 
                                    <h5 class="card-title">Vencimiento: {{ $sentencia->fecha_vencimiento }}</h5> 
                                    <br>
