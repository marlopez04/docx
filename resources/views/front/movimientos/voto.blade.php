                                        ...
                                        <div class="row">                                       
                                            <div class="col-md-12 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="motivo" class="form-control" id="floatingTextarea2" style="height: 100px">Envio voto.</textarea>
                                                    ...
                                                    <input type="text" value="voto" name="qhaci" class="form-control" >
